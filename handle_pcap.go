...
func closeConnection(packet *packet_metadata, ipMeta *myCsMap, writingQueue chan *packet_metadata, write bool, ackingFirewall bool) {
...
func HandlePcap(opts *options, packet *packet_metadata, ipMeta *myCsMap, timeoutQueue chan *packet_metadata,
