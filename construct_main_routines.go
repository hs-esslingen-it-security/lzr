...
func PollTimeoutRoutine(ipMeta *myCsMap, timeoutQueue chan *packet_metadata, retransmitQueue chan *packet_metadata,
...
func timeoutAlg(ipMeta *myCsMap, queue chan *packet_metadata, timeoutIncoming chan *packet_metadata,
